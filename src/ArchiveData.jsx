...
export const ArchiveProvider = ({ children }) => {
  ...
  const [archives] = useState([
    {
      ...
      folder: "React",
      preface:
        "React 是由 Facebook 開發的一個用於構建用戶界面的 JavaScript 函式庫，" +
        "專注於高效、靈活地創建互動式 UI。" +
      ...
      content: [
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "React 是基於 JavaScript 的，因此需要熟練掌握以下 JavaScript 技能：",
          },
          {
            type: "checkList",
            describe: [
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "理解 Git 的基本命令，例如 clone, commit, push, pull。\n\n" +
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "安裝 Node.js 並理解其作用(用於運行 JavaScript)。\n\n" +
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "理解 SPA(Single Page Application)單頁應用的基本概念。\n\n" +
              "掌握模組化和元件化的思想。",
          },
        ],
        [
          ...
          },
          {
            type: "text",
            describe:
              "JSX：React 的語法擴展，讓 HTML 與 JavaScript 結合。\n\n" +
              "元件：理解如何創建函式元件和類元件。\n\n" +
    ...
    },
    {
      ...
      folder: "Travel",
      preface:
        "在新竹讀書的那幾年都沒有好好的認識這一個縣市，對他的印象也只限於貢丸、米粉、落山風，" +
      ...
      content: [
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "香山區的地名典雅，傳說是國姓爺(鄭成功)治台時，此地為竹塹社番所居往，沒有固定名稱，" +
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "新竹曾經是台灣原住民平埔族道卡斯族的美麗故鄉，而其舊稱「竹塹」也是由道卡斯族語而來，" +
    ...
    },
    {
      ...
      folder: "reflections",
      preface:
        "準備考研的這段時間既難熬又痛苦。當初因為未能咬牙堅持下去，最終導致結果不盡人意。\n\n" +
      ...
      content: [
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "在制定計劃前，我先上網搜尋了許多學長留下來考研經驗，並了解是否需要報補習班。\n\n" +
          ...
          },
          {
            ...
            describe: [
              "計算機數學類(線性代數、離散數學)",
              "程式設計(資料結構、演算法)",
              "計算機組織計算機組織(作業系統、計算機組織)",
            ],
          },
          {
            type: "text",
            describe:
              "在熟悉課綱後，我著手規劃從五月到考試期間的詳細計畫，並將整體學習分為四個部分：",
          },
          {
            type: "checkList",
            describe: [
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "剛開始上補習班時，我有些不適應，本以為是老師當面授課，但到了現場發現是觀看已錄製好的課程，想到既然如此，" +
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "我認為這個階段是最容易偷懶的階段，因為剛看完所有課程時，總覺得自己已經掌握得差不多了，似乎不需要再重新複習一遍。\n\n" +
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "由於上個階段沒有好好複習，導致我的基礎不夠扎實，在開始寫考古題時，錯誤連連，對許多解法及術語都一竅不通。\n\n" +
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "為了盡快趕上進度，我將計畫從一天兩小時改為四小時，並每天集中精力練習一整年的考古題，讓自己進入備戰的狀態。\n\n" +
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "我總共報考了四間學校，在準備這幾間學校的考試時，寫考古題的過程還算順利，" +
        ...
        [
          ...
          },
          {
            type: "text",
            describe:
              "當成績單寄來後，結果和預想的差別不大，全是毫無機會的備取名額。\n\n" +
  ...
  const [isLight, setIsLight] = useState(true); //檢查是否為日光
  const toggleLight = () => setIsLight((prev) => !prev); //控制日夜
  const modelStyle = isLight ? "bg-white" : "bg-dark text-white";
  const modelText= isLight?"":"text-white"
  const modelAnnotation = isLight ? "gray" : "rgb(218,215,215)";
  const modelIcon = isLight ? "" : "invert(100%) brightness(200%)";
  ...
  return (
    ...
    >
      <div
        style={{
          backgroundColor: isLight ? "rgb(251, 246, 234)" : "rgb(0,0,0,0.900)",
